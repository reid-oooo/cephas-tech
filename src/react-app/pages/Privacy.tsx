      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
          <div className="prose prose-slate max-w-none">
            <h1 className="text-4xl font-serif text-slate-900 mb-6">Privacy Policy</h1>
            ...
            <p className="text-lg text-slate-700 mb-8">
              We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the <a href="https://www.privacypolicies.com/privacy-policy-generator/" target="_blank" rel="noopener noreferrer" className="text-amber-600 hover:text-amber-700 underline">Privacy Policy Generator</a>.
            </p>
            ...
            <ul className="list-disc pl-6 space-y-3 text-slate-700 mb-8">
              ...
              <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Cephas Tech Partners</li>
              ...
              <li><strong>Website</strong> refers to Cephas Consulting Site, accessible from <a href="https://www.cephas.tech" rel="external nofollow noopener" target="_blank" className="text-amber-600 hover:text-amber-700 underline">https://www.cephas.tech</a></li>
            ...
            <p className="text-slate-700 mb-4">We may share Your personal information in the following situations:</p>
            <ul className="list-disc pl-6 space-y-3 text-slate-700 mb-8">
            ...
            <h2 className="text-2xl font-bold text-slate-900 mt-12 mb-6">Links to Other Websites</h2>
            <p className="text-slate-700 mb-6">
            ...
            <h2 className="text-2xl font-bold text-slate-900 mt-12 mb-6">Changes to this Privacy Policy</h2>
            <p className="text-slate-700 mb-6">
            ...
            <p className="text-slate-700 mb-4">If you have any questions about this Privacy Policy, You can contact us:</p>
            <ul className="list-disc pl-6 space-y-2 text-slate-700 mb-8">
