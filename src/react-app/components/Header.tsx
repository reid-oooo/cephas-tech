      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex space-x-8">
            ...
            <a href="#about" className="text-slate-300 hover:text-amber-500 transition-colors font-medium">
              About
            </a>
            <a href="#process" className="text-slate-300 hover:text-amber-500 transition-colors font-medium">
              Process
            </a>
            <a href="#case-studies" className="text-slate-300 hover:text-amber-500 transition-colors font-medium">
              Case Studies
            </a>
